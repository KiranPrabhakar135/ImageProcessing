...
{
	String s;
	FileImageOutputStream fo1=new FileImageOutputStream(new File("E://project/sample/kkkk.png"));
	Picture p=new Picture(1000,1000);
	//File f1=new File("E:/Kiran.jpg");
	Crypter c=new Crypter("E:/project/sample/Sample.png");
        //String s=new String("abcdef");
        //File f1=new File("E:/Kiran.jpg");
	//File f2=new File("E:/kiran11.txt");
	c.encrypt("abcdef","E:/project/sample/Sample.png"); 
        s=c.deCrypt("E:/project/sample/Sample.png");
